    ...
    public function getTabs(): array
    {
        return [
            ...
            'pending' => \Filament\Schemas\Components\Tabs\Tab::make('Pending')
                ->badge(\App\Models\VehicleRequest::where('status', 'pending')->count())
                ->badgeColor('warning')
            ...
            'approved' => \Filament\Schemas\Components\Tabs\Tab::make('Approved')
                ->badge(\App\Models\VehicleRequest::where('status', 'approved')->count())
                ->badgeColor('success')
            ...
            'on_trip' => \Filament\Schemas\Components\Tabs\Tab::make('On Trip')
                ->badge(\App\Models\VehicleRequest::where('status', 'on_trip')->count())
                ->badgeColor('info')
            ...
            'completed' => \Filament\Schemas\Components\Tabs\Tab::make('Completed')
                ->badge(\App\Models\VehicleRequest::where('status', 'completed')->count())
                ->badgeColor('success')
            ...
            'rejected' => \Filament\Schemas\Components\Tabs\Tab::make('Rejected')
                ->badge(\App\Models\VehicleRequest::where('status', 'rejected')->count())
                ->badgeColor('danger')
